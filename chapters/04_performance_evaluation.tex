...
The integration layer implements the different integration styles of the two prototypes. The batch prototype uses a file-based integration with files being transfered using \ac{FTP}. The messaging prototype uses a messaging middleware for exchanging messages.

\begin{figure}[htbp]
	\centering
	\subfloat[Batch integration]{\includegraphics[width=0.4\textwidth]{ch4_batch_integration}\label{fig:ch4_batch_integration}}
	\qquad
	\subfloat[Messaging middleware]{\includegraphics[width=0.4\textwidth]{ch4_messaging_integration}\label{fig:ch4_messaging_integration}}
	\caption{Batch and messaging integration}
\end{figure}
