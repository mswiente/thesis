...
\begin{figure}
	[htpb] \centering 
	\includegraphics[width=\textwidth]{ch6_conceptual_framework_packages} \caption{Package structure} \label{fig:ch6_packages} 
\end{figure}
...
\begin{figure}[htpb] \centering 
	\includegraphics[width=\textwidth]{ch6_metamodel_phase} 
...
\begin{figure}[htpb] \centering 
	\includegraphics[width=\textwidth]{ch6_metamodel_role} 
...
\begin{figure}[htpb] \centering 
	\includegraphics[width=\textwidth]{ch6_tasks_packages} 
	\caption{Subpackages of the Tasks package} 
	\label{fig:ch6_tasks_packages} 
\end{figure}

A Task is described by the following attributes, as shown in Figure \ref{fig:ch6_metamodel_task}:
\begin{itemize}
	\item \textbf{Name}\\
...
\begin{figure}[htpb] \centering 
	\includegraphics[width=\textwidth]{ch6_metamodel_task} 
...
\subsubsection{Create System Model / Perform System Identification}
	\begin{tabularx}{\textwidth}{@{} l X @{}}
...
\subsubsection{Implement Routing-Rules}
\begin{tabularx}{\textwidth}{@{} l X @{}}
...
\subsubsection{Perform Staffing}
...
\begin{figure}[htpb] \centering 
	\includegraphics[width=\textwidth]{ch6_process_integration_tasks} 
...
\begin{figure}[htpb] \centering 
	\includegraphics[width=\textwidth]{ch6_process_integration} 
...
\begin{figure}[htpb] \centering 
	\includegraphics[width=\textwidth]{ch6_process_aggregation_tasks} 
...
\begin{figure}[htpb] \centering 
	\includegraphics[width=\textwidth]{ch6_process_aggregation} 
...
This process contains tasks that are concerned with the design, implementation and tuning of the feedback-control loop. It contains the following tasks, as shown in Figure \ref{fig:ch6_tasks_feedback_control}.

\begin{figure}[htpb] \centering 
	\includegraphics[width=\textwidth]{ch6_process_feedback-control_tasks} 
...
\begin{figure}[htpb] \centering 
	\subfloat[Using a model]{\includegraphics[width=0.5\textwidth]{ch6_process_feedback-control_modelling}\label{fig:ch6_process_feedback-control_modelling}}\qquad
	\subfloat[Without a model]{\includegraphics[width=0.5\textwidth]{ch6_process_feedback-control}\label{fig:ch6_process_feedback-control}}
...
\begin{figure}[htpb] \centering 
	\includegraphics[width=\textwidth]{ch6_metamodel_artifact} 
...
\begin{figure}[htpb] \centering 
	\includegraphics[width=\textwidth]{ch6_metamodel_tool} 
...
\cite{Inverardi:2010ki} describe a process methodology to support the development of context-aware adaptive applications. It consists of four different activities: \emph{Explore}, \emph{Integrate}, \emph{Validate} and \emph{Evolve}:
\begin{itemize}
