...
\newcommand{\myLocation}{Frankfurt, Germany\xspace}
...
% small itemlists for table items
\usepackage{enumitem}
\newlist{titemize}{itemize}{4}
\setlist[titemize]{label={--},noitemsep,leftmargin=*,topsep=0pt,partopsep=0pt}
\newcommand{\savespace}{\mbox{}\par\vspace{-\baselineskip}}
